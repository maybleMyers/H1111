# Attention dispatch + mixin shims for the vendored Cosmos3 transformer.
#
...
# cosmos_video/transformer.py): query/key/value are [batch, seq, heads, head_dim] and the output is
