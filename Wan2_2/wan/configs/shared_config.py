...
# Missing attributes needed for compatibility
wan_shared_cfg.is_fun_control = False
wan_shared_cfg.in_channels = 16  # Default input channels for latent (overridden per model)
